...
interface FloatingElementsProps {
  customElements?: typeof elements
}

export function FloatingElements({ customElements = elements }: FloatingElementsProps) {
...
function FloatingElement({ element }: FloatingElementProps) {
